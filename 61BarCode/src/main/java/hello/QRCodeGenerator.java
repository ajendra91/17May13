...
public class QRCodeGenerator {
	...
	private static String QRCODE_PATH = "ajay/";
	...
	public static void main(String[] args) throws Exception {
		QRCodeGenerator codeGenerator = new QRCodeGenerator();
		 ...
		 //PaytmRequestBody("ajendra", "1234567890", "Personal", "acc23457612")));
		 
		System.out.println(codeGenerator.readQRCode(QRCODE_PATH + "ajendra-QRCODE.png"));
	}
}
